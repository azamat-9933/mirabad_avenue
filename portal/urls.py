...
urlpatterns = [
    ...
    path("api/checklist/item/", views.api_checklist_item, name="api_checklist_item"),
    path("api/checklist/item", views.api_checklist_item, name="api_checklist_item_no_slash"),
